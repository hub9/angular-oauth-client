...
var AuthService = (function () {
    ...
    AuthService.prototype.login = function (username, password) {
        ...
        var r = this.http.post(this.config.apiOauthUrl + 'token/', data, options);
    ...
    AuthService.prototype.refresh_token = function () {
        ...
        var options = new http_1.RequestOptions({ headers: headers });
        return this.http.post(this.config.apiOauthUrl + 'token/', data, options)["do"](function (d) {
        }, function (e) {
            if (e.status === 401) {
                _this.logout();
            }
    ...
    AuthService.prototype.request = function (method, url, data, headers) {
        ...
        return Rx.Observable.create(function (obs) {
            _this.getToken().subscribe(function (d1) {
                ...
                _this.http.request(_this.config.apiUrl + url, options).subscribe(function (d2) {
                    if (d2.status === 204) {
                        obs.next(null);
                    }
                    else {
